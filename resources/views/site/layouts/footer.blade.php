      ...
      <div class="row row-30 justify-content-center">
        <div class="col-md-10 col-lg-12 col-xl-4 wow fadeInRight">
          <div class="box-footer box-footer-small">
            <div class="footer-brand"><a href="../index-2.html"><img src="images/logo-inverse-190x43.png" alt="" width="190" height="43"/></a></div>
        ...
        <div class="col-md-10 col-lg-6 col-xl-4 wow fadeInRight" data-wow-delay=".1s">
          <div class="box-footer">
            ...
            <form class="rd-form rd-mailform" data-form-output="form-output-global" data-form-type="contact" method="post" action="../../../external.html?link=https://livedemo00.template-help.com/wt_prod-8852/theme/bat/rd-mailform.php">
              <div class="form-wrap">
              ...
              <button class="button button-block button-ujarak button-primary" type="submit">Send Message</button>
            </form>
          </div>
        </div>
